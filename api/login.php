...
require_once __DIR__ . '/../config/session_config.php'; // Session管理
...
// 登录成功，使用SessionManager设置用户session
$sessionManager->setUserSession($user['id'], [
    'id' => $user['id'],
...
// 记录调试日志
error_log("[LOGIN] 用户 {$user['id']} 登录成功，数据库session已设置");
