...
require_once 'auth_unified.php'; // 2025-01-27 新增：统一认证支持
...
try {
    ...
    // 2025-01-27 修复：字段名从updated_at改为last_operation_time
    $sql = "SELECT wallpaper_id, last_operation_time FROM wallpaper_exile_status WHERE status = 1 ORDER BY last_operation_time DESC";
    ...
    if ($result) {
        ...
        while ($row = $result->fetch_assoc()) {
            $exiledData[] = [
                ...
                'exile_time' => $row['last_operation_time']
            ];
        }
